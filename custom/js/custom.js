...
// 进行 fetch 请求
fetch('https://api.nsmao.net/api/ip/query?key=z2BvRnlFZnm1OrqZvegaLjv3mG') //申请key:https://api.nsmao.net
.then(response => {
if (!response.ok) {
...
return;
 ...
 let dist = getDistance(109.72, 32.32, ipLocation.data.lng, ipLocation.data.lat); // 修改自己的经度（121.413921）纬度（31.089290）
