function initialize_fc_lite() {
    ...
    UserConfig = {
        ...
        error_img: UserConfig?.error_img || "https://fastly.jsdelivr.net/gh/HxCodeWarrior/Friend-Circle-Lite@latest/static/favicon.ico" // 默认头像
    };
    ...
    function processArticles(data) {
        ...
        statsContainer.innerHTML = `
            <div>Powered by: <a href="https://github.com/HxCodeWarrior/Friend-Circle-Lite" target="_blank">FriendCircleLite</a><br></div>
            <div>Designed By: <a href="https://blog.devnest.top/" target="_blank">LiuShen</a><br></div>
    ...
    function displayRandomArticle() {
        ...
        randomArticleContainer.innerHTML = `
            <div class="random-container">
                <div class="random-container-title">🪴随机君友</div>
                <div class="random-title">${randomArticle.title}</div>
                <div class="random-author">君名: ${randomArticle.author}</div>
            </div>
            <div class="random-button-container">
                <a href="#" id="refresh-random-article">🎍换一个</a>
